...
def get_crop_hint(path):
    ...
    with io.open("C:\Users\davez\Desktop\crop_hits\api\crop\resources\cat.jpg", 'rb') as image_file:
...
def draw_hint(image_file):
    ...
    # [START draw_hint]
    vects = get_crop_hint("C:\Users\davez\Desktop\crop_hits\api\crop\resources\cat.jpg")
...
if __name__ == '__main__':
    ...
    if args.mode == 'crop':
        crop_to_hint(args."C:\Users\davez\Desktop\crop_hits\api\crop\resources\cat.jpg")
    elif args.mode == 'draw':
